...
# Capas no disponibles por an~o
else if (year == 1995 & (capa == "ageb" | capa == "urbano" | capa == "rural")) {stop("Las capas ageb, urbano o rural no estan disponibles para el an~o 1995.")}
  else if (year == 2000 & (capa == "urbano" | capa == "rural")) {stop("Las capas urbano o rural no estan disponibles para el an~o 2000.")}
  else if (year == 2005 & (capa == "urbano" | capa == "rural")) {stop("Las capas urbano o rural no estan disponibles para el an~o 2005.")}
  else if (year == 2010 & capa == "ageb" & version == "5.0.A") {stop("La capa ageb no esta disponible para el an~o 2010 5.0.A")}
  # Inicio --------------------------------------------------------------------
